...
<div class="h-fit ">
	...
	<div class="   ">
		<div
			class="dark:md:border-[#42395a] dark:border-[#3e394d] dark:border-b-2 dark:md:border  pt-8 md:pt-6  pb-6 md:ml-3 md:mr-1  md:mt-2  to-[#cee99d] from-[#74ddb1] bg-gradient-to-tr md:rounded-lg  dark:from-[#282338] dark:to-[#2e283d] dark:shadow-none shadow-md md:shadow-neutral-400"
		>
			<div
	...
	<div class=" p-4	dark:md:border dark:border-[#3e394d] md:mt-4   bg-[#fbfcfd] dark:bg-[#2c2836] md:border   ml-0 md:ml-2  md:mb-2 md:rounded-lg">
		...
		<div class="mb-2 border-b-2 dark:border-[#4f4d5c] border-neutral-200 h-fit pb-4">
			...
			<SkillBar
				percentage={'70%'}
				title={'Typescript'}
				imgHTML={"<img class='' alt='Typescript' src='/logos/typescript.svg' />"}
			/>
			<SkillBar
				percentage={'90%'}
				title={'Javascript'}
				imgHTML={"<img class='max-h-full py-2 saturate-[0.8]' alt='Javascript' src='/logos/javascript.svg' />"}
			/>
			<SkillBar
				percentage={'85%'}
				title={'HTML'}
				imgHTML={"<img class='max-h-full  py-2 saturate-[0.8]  ' alt='HTML' src='/logos/html5.svg' />"}
			/>
			<SkillBar
				percentage={'85%'}
				title={'CSS 3'}
				imgHTML={"<img class='max-h-full saturate-[0.8] py-2' alt='css3' src='/logos/css3.svg' />"}
			/>
			<SkillBar
				percentage={'50%'}
				title={'Java'}
		...
		<div class="mb-2 border-b-2 dark:border-[#4f4d5c] border-neutral-200 h-fit pb-4">
			...
			<SkillBar
				percentage={'85%'}
				title={'Svelte'}
				imgHTML={"<img class='' alt='svelte' src='/logos/svelte.svg' />"}
			/>
			<SkillBar
				percentage={'60%'}
				title={'Sveltekit'}
				imgHTML={"<img class='' alt='sveltekit' src='/logos/sveltekit.svg' />"}
			/>
			<SkillBar
				percentage={'90%'}
				title={'TailwindCSS'}
		...
		<div class="mb-2 border-b-2 dark:border-[#4f4d5c] border-neutral-200 h-fit pb-4">
			...
			<SkillBar
				percentage={'85%'}
				title={'Mysql'}
				imgHTML={"<img class='' alt='mysql' src='/logos/mysql.svg' />"}
			/>
			<SkillBar
				percentage={'40%'}
				title={'MongoDB'}
				imgHTML={"<img class='' alt='mongodb' src='/logos/mongodb.svg' />"}
			/>
		</div>
		<div class=" pb-4 mb-2">
		...
		<div class="dark:bg-[#443f4e] bg-[#57b68e] p-2 py-2 text-center">
			<a
