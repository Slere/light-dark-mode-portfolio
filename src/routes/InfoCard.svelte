...
<div class="h-fit ">
	...
	<div class="   ">
		<div
			class="pt-8 md:pt-6  pb-6 md:ml-3 md:mr-1  md:mt-2 dark:from-inherit dark:to-inherit to-[#cee99d] from-[#74ddb1] bg-gradient-to-tr md:rounded-lg  dark:bg-[#342f3f] dark:shadow-none shadow-md md:shadow-neutral-400"
		>
			<div
