				...
				>
					...
					{#if github}
						<a
							...
							target="_blank"
							rel="noreferrer"
							class="pointer-events-none group-hover:pointer-events-auto group-hover:cursor-pointer px-1 underline-offset-2 hover:underline capitalize hover:text-[#5d806d] dark:hover:text-neutral-100"
							><svg
